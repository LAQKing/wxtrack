...
class Tracker extends Wrapper {
  constructor({ tracks, isUsingPlugin, base_url, appid, appkey, debug }) {
    super(isUsingPlugin, base_url, appid, appkey, debug)
    // 埋点配置信息
    this.tracks = tracks
